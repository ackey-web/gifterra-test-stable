...
var init_version5 = __esm({
  "node_modules/.pnpm/@ethersproject+abstract-signer@5.8.0/node_modules/@ethersproject/abstract-signer/lib.esm/_version.js"() {
    version5 = "abstract-signer/5.8.0";
  }
});
...
var init_version6 = __esm({
  "node_modules/.pnpm/@ethersproject+abstract-provider@5.8.0/node_modules/@ethersproject/abstract-provider/lib.esm/_version.js"() {
    version6 = "abstract-provider/5.8.0";
  }
});
...
var init_ws = __esm({
  "node_modules/.pnpm/@ethersproject+providers@5.8.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/ws.js"() {
    ...
    try {
      ...
      const logger34 = new Logger(version14);
      WS = function() {
        logger34.throwError("WebSockets not supported in this environment", Logger.errors.UNSUPPORTED_OPERATION, {
...
var logger31, defaultApiKey4, QuickNodeProvider;
...
var logger32, _nextId, Web3Provider;
  ...
  "node_modules/.pnpm/@ethersproject+providers@5.8.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/web3-provider.js"() {
    ...
    Web3Provider = class extends JsonRpcProvider {
      constructor(provider, network) {
        if (provider == null) {
          logger32.throwArgumentError("missing provider", "provider", provider);
        }
        let path = null;
        ...
        if (typeof provider === "function") {
          ...
          if (provider.request) {
            ...
            logger32.throwArgumentError("unsupported provider", "provider", provider);
          }
          if (!path) {
            path = "unknown:";
          }
  ...
  if (typeof network === "string") {
    ...
    if (match) {
      switch (match[1].toLowerCase()) {
        ...
        default:
          logger33.throwArgumentError("unsupported URL scheme", "network", network);
      }
    }
  }
  const n = getNetwork(network);
  if (!n || !n._defaultProvider) {
    logger33.throwError("unsupported getDefaultProvider network", Logger.errors.NETWORK_ERROR, {
...
js-sha3/src/sha3.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NPRSAB35.js.map
