...
// node_modules/.pnpm/@thirdweb-dev+merkletree@0.2.6/node_modules/@thirdweb-dev/merkletree/dist/thirdweb-dev-merkletree.esm.js
...
var MerkleTree = class _MerkleTree extends Base$1 {
  duplicateOdd = false;
  concatenator = import_buffer.Buffer.concat;
  hashLeaves = false;
  isBitcoinTree = false;
  leaves = [];
  layers = [];
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/signature-d3ea643d.browser.esm.js
init_lib();
...
var CurrencyValueSchema = (() => CurrencySchema.extend({
  ...
  displayValue: external_exports.string()
}))();
var ClaimConditionMetadataSchema = (() => external_exports.object({
  name: external_exports.string().optional()
}).catchall(external_exports.unknown()))();
var ClaimConditionInputSchema = (() => external_exports.object({
  startTime: StartDateSchema,
  currencyAddress: external_exports.string().default(NATIVE_TOKEN_ADDRESS),
  ...
  snapshot: external_exports.optional(SnapshotInputSchema).nullable(),
  metadata: ClaimConditionMetadataSchema.optional()
}))();
var ClaimConditionInputArray = (() => external_exports.array(ClaimConditionInputSchema))();
...
var BaseSignaturePayloadInput = (() => external_exports.object({
  ...
  uid: external_exports.string().optional().transform((arg) => resolveOrGenerateId(arg)),
...
var Signature721PayloadInput = (() => BaseSignaturePayloadInput.extend({
  ...
  royaltyRecipient: external_exports.string().default(lib_exports.AddressZero),
...
//# sourceMappingURL=chunk-YXMD7WT5.js.map
