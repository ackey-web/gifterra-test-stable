...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/erc-1155-7ce9bee1.browser.esm.js
init_lib();
...
var DropErc1155ClaimConditions = class {
  ...
  async getClaimIneligibilityReasons(tokenId, quantity, addressToCheck) {
    ...
    if (claimCondition.price.gt(0) && isNode()) {
      ...
      if (isNativeToken(claimCondition.currencyAddress)) {
        ...
        const IERC20ABI = (await import("./IERC20-YYBYRFC2.js")).default;
   ...
   */
  set = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this = this;
   ...
   * @param resetClaimEligibilityForAll - Whether to reset the state of who already claimed NFTs previously
   */
  setBatch = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this2 = this;
   ...
   */
  update = buildTransactionFunction(async (tokenId, index, claimConditionInput) => {
...
var AirdropAddressInput = (() => external_exports.object({
  address: AddressOrEnsSchema,
  quantity: AmountSchema.default(1)
}))();
var AirdropInputSchema = (() => external_exports.union([external_exports.array(external_exports.string()).transform(async (strings) => await Promise.all(strings.map((address) => AirdropAddressInput.parseAsync({
  address
})))), external_exports.array(AirdropAddressInput)]))();
var ERC1155Claimable = class {
   ...
   */
  to = buildTransactionFunction(async (destinationAddress, tokenId, quantity, options) => {
...
var Erc1155SignatureMintable = class {
   ...
   */
  mint = buildTransactionFunction(async (signedPayload) => {
   ...
   * @twfeature ERC1155SignatureMintable
   */
  mintBatch = buildTransactionFunction(async (signedPayloads) => {
...
var Erc1155Burnable = class {
   ...
   * ```
   */
  tokens = buildTransactionFunction(async (tokenId, amount) => {
   ...
   * ```
   */
  from = buildTransactionFunction(async (account, tokenId, amount) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "burn",
   ...
   * ```
   */
  batch = buildTransactionFunction(async (tokenIds, amounts) => {
    const account = await this.contractWrapper.getSignerAddress();
   ...
   * ```
   */
  batchFrom = buildTransactionFunction(async (account, tokenIds, amounts) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "burnBatch",
...
var Erc1155LazyMintable = class {
   ...
   */
  lazyMint = buildTransactionFunction(async (metadatas, options) => {
  ...
  updateMetadata = buildTransactionFunction(async (tokenId, metadata, options) => {
...
var Erc1155BatchMintable = class {
   ...
   * ```
   */
  to = buildTransactionFunction(async (to, metadataWithSupply) => {
...
var Erc1155Mintable = class {
   ...
   * ```
   */
  additionalSupplyTo = buildTransactionFunction(async (to, tokenId, additionalSupply) => {
...
var Erc1155 = class {
   ...
   * @twfeature ERC1155
   */
  transfer = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this = this;
   ...
   */
  transferBatch = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this2 = this;
   ...
   * @twfeature ERC1155
   */
  transferFrom = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this3 = this;
   ...
   * @twfeature ERC1155
   */
  setApprovalForAll = buildTransactionFunction(async (operator, approved) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
   ...
   * @twfeature ERC1155BatchTransferable
   */
  airdrop = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this4 = this;
   ...
   */
  mint = buildTransactionFunction(async (metadataWithSupply) => {
   ...
   * @twfeature ERC1155Mintable
   */
  mintTo = buildTransactionFunction(async (receiver, metadataWithSupply) => {
   ...
   * @twfeature ERC1155Mintable
   */
  mintAdditionalSupply = buildTransactionFunction(async (tokenId, additionalSupply) => {
   ...
   * @twfeature ERC1155Mintable
   */
  mintAdditionalSupplyTo = buildTransactionFunction(async (receiver, tokenId, additionalSupply) => {
   ...
   */
  mintBatch = buildTransactionFunction(async (metadataWithSupply) => {
   ...
   * @twfeature ERC1155BatchMintable
   */
  mintBatchTo = buildTransactionFunction(async (receiver, metadataWithSupply) => {
   ...
   */
  burn = buildTransactionFunction(async (tokenId, amount) => {
   ...
   * @twfeature ERC1155Burnable
   */
  burnFrom = buildTransactionFunction(async (account, tokenId, amount) => {
   ...
   * @twfeature ERC1155Burnable
   */
  burnBatch = buildTransactionFunction(async (tokenIds, amounts) => {
   ...
   * @twfeature ERC1155Burnable
   */
  burnBatchFrom = buildTransactionFunction(async (account, tokenIds, amounts) => {
   ...
   */
  updateMetadata = buildTransactionFunction(async (tokenId, metadata) => {
   ...
   */
  claim = buildTransactionFunction(async (tokenId, quantity, options) => {
   ...
   * @twfeature ERC1155ClaimCustom | ERC1155ClaimPhasesV2 | ERC1155ClaimPhasesV1 | ERC1155ClaimConditionsV2 | ERC1155ClaimConditionsV1
   */
  claimTo = buildTransactionFunction(async (destinationAddress, tokenId, quantity, options) => {
    const claimWithConditions = this.claimWithConditions;
    const claim = this.claimCustom;
    if (claimWithConditions) {
...
//# sourceMappingURL=chunk-EXDIX5RQ.js.map
