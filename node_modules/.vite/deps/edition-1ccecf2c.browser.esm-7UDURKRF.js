...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/edition-1ccecf2c.browser.esm.js
init_lib();
var import_bn = __toESM(require_bn());
var import_bs58 = __toESM(require_bs58());
var import_utils = __toESM(require_utils());
var import_fast_deep_equal = __toESM(require_fast_deep_equal());
var Edition = class _Edition extends StandardErc1155 {
   ...
   * ```
   */
  mintTo = buildTransactionFunction(async (to, metadataWithSupply) => {
   ...
   * @param additionalSupply - the additional amount to mint
   */
  mintAdditionalSupplyTo = buildTransactionFunction(async (to, tokenId, additionalSupply) => {
   ...
   * ```
   */
  mintBatchTo = buildTransactionFunction(async (to, metadataWithSupply) => {
...
//# sourceMappingURL=edition-1ccecf2c.browser.esm-7UDURKRF.js.map
