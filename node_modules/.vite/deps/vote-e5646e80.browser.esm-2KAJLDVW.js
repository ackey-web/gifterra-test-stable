...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/vote-e5646e80.browser.esm.js
init_lib();
...
var Vote = class {
   ...
   */
  propose = buildTransactionFunction(async (description, executions) => {
    if (!executions) {
      executions = [{
   ...
   */
  vote = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this = this;
   ...
   */
  execute = buildTransactionFunction(async (proposalId) => {
    await this.ensureExists(proposalId);
    const proposal = await this.get(proposalId);
    const tos = proposal.executions.map((p) => p.toAddress);
    const values = proposal.executions.map((p) => p.nativeTokenValue);
...
//# sourceMappingURL=vote-e5646e80.browser.esm-2KAJLDVW.js.map
