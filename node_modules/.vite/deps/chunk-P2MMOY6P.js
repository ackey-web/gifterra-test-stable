...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/contract-appuri-5c40af52.browser.esm.js
init_lib();
...
var ContractMetadata = class {
   ...
   * @twfeature ContractMetadata
   * */
  update = buildTransactionFunction(async (metadata) => {
...
var ContractAppURI = class {
   ...
   * @twfeature AppURI
   */
  set = buildTransactionFunction(async (appURI) => {
    if (detectContractFeature(this.contractWrapper, "AppURI")) {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "setAppURI",
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/fetchCurrencyValue-32d08b05.browser.esm.js
init_lib();
...
async function fetchCurrencyMetadata(provider, asset) {
  if (isNativeToken(asset)) {
    ...
    const ERC20MetadataAbi = (await import("./IERC20Metadata-JCJJMM3S.js")).default;
...
//# sourceMappingURL=chunk-P2MMOY6P.js.map
