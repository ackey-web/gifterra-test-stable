...
import {
  parseAbiItem
} from "./chunk-HWDUXV26.js";
import {
  hexToUint8Array,
  isHex,
  uint8ArrayToHex
} from "./chunk-AS7Y3LQA.js";
import {
  ContractPublisher
} from "./chunk-R7MM6V5H.js";
import {
  createTransactionBatches,
  deployContractDeterministic,
  deployWithThrowawayDeployer,
  getDeploymentInfo
} from "./chunk-6NV6YXVG.js";
import {
  fetchSourceFilesFromMetadata
} from "./chunk-WILOY3HU.js";
import {
...
// node_modules/.pnpm/@thirdweb-dev+contracts-js@1.3.23_ethers@5.8.0_bufferutil@4.0.9_utf-8-validate@5.0.10_/node_modules/@thirdweb-dev/contracts-js/dist/abis/TWMultichainRegistryRouter.json
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/sdk-3e21fc5c.browser.esm.js
init_lib();

// node_modules/.pnpm/@thirdweb-dev+generated-abis@0.0.2/node_modules/@thirdweb-dev/generated-abis/dist/thirdweb-dev-generated-abis.esm.js
var GENERATED_ABI = {};

// node_modules/.pnpm/@thirdweb-dev+contracts-js@1.3.23_ethers@5.8.0_bufferutil@4.0.9_utf-8-validate@5.0.10_/node_modules/@thirdweb-dev/contracts-js/dist/abis/TWFactory.json
...
var MultichainRegistry = class {
  ...
  addContract = buildTransactionFunction(async (contract) => {
  ...
  addContracts = buildTransactionFunction(async (contracts) => {
    const deployerAddress = await this.registryRouter.getSignerAddress();
    const encoded = [];
  ...
  removeContract = buildTransactionFunction(async (contract) => {
    const deployerAddress = await this.registryRouter.getSignerAddress();
    return Transaction.fromContractWrapper({
      contractWrapper: this.registryLogic,
      method: "remove",
  ...
  removeContracts = buildTransactionFunction(async (contracts) => {
    const deployerAddress = await this.registryRouter.getSignerAddress();
    const contractEncoder = new ContractEncoder(this.registryLogic);
...
var ContractFactory2 = class extends ContractWrapper {
  ...
  deploy = buildTransactionFunction(async (contractType, contractMetadata, eventEmitter, version, options, onExecute) => {
  ...
  deployProxyByImplementation = buildTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs, eventEmitter, saltForProxyDeploy, onExecute) => {
...
var ContractRegistry = class extends ContractWrapper {
  ...
  addContract = buildTransactionFunction(async (contractAddress) => {
    return await this.addContracts.prepare([contractAddress]);
  });
  addContracts = buildTransactionFunction(async (contractAddresses) => {
  ...
  removeContract = buildTransactionFunction(async (contractAddress) => {
    return await this.removeContracts.prepare([contractAddress]);
  });
  removeContracts = buildTransactionFunction(async (contractAddresses) => {
    const deployerAddress = await this.getSignerAddress();
    const contractEncoder = new ContractEncoder(this);
...
var ThirdwebSDK = class _ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import("./smart-contract-ac432d60.browser.esm-IUU4MMMV.js")]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
...
var ContractDeployer = class extends RPCConnectionHandler {
   ...
   */
  deployNFTCollection = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployNFTDrop = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployLoyaltyCard = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployOpenEdition = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deploySignatureDrop = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @beta
   */
  deployMultiwrap = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployEdition = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployEditionDrop = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployToken = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployTokenDrop = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployMarketplace = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployMarketplaceV3 = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployPack = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deploySplit = buildDeployTransactionFunction(async (metadata, options) => {
   ...
   * @returns The address of the deployed contract
   */
  deployVote = buildDeployTransactionFunction(async (metadata, options) => {
    return await this.deployBuiltInContract.prepare(VoteInitializer.contractType, metadata, "latest", options);
  });
  deployAirdropERC20 = buildDeployTransactionFunction(async (metadata, options) => {
  ...
  deployAirdropERC721 = buildDeployTransactionFunction(async (metadata, options) => {
    const parsedMetadata = await AirdropContractDeploy.parseAsync(metadata);
    const contractURI = await this.storage.upload(parsedMetadata);
    const trustedForwarders = [];
    if (metadata.trusted_forwarders && metadata.trusted_forwarders.length > 0) {
  ...
  deployAirdropERC1155 = buildDeployTransactionFunction(async (metadata, options) => {
    const parsedMetadata = await AirdropContractDeploy.parseAsync(metadata);
    const contractURI = await this.storage.upload(parsedMetadata);
    const trustedForwarders = [];
    if (metadata.trusted_forwarders && metadata.trusted_forwarders.length > 0) {
   ...
   */
  deployBuiltInContract = buildDeployTransactionFunction(/* @__PURE__ */ (() => {
    var _this = this;
   ...
   * @internal
   */
  deployReleasedContract = buildDeployTransactionFunction(/* @__PURE__ */ (() => {
    var _this2 = this;
   ...
   */
  deployViaFactory = buildTransactionFunction(async (factoryAddress, implementationAddress, implementationAbi, initializerFunction, initializerArgs, saltForProxyDeploy) => {
   ...
   * @param initializerArgs - the initializer args to pass to the initializer function
   */
  deployProxy = buildDeployTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs) => {
    ...
    const {
      TWProxy__factory
    } = await import("./thirdweb-dev-contracts-js-factories-TWProxy__factory.esm-4F2FRP2O.js");
   ...
   * @internal
   */
  deployViaAutoFactory = buildDeployTransactionFunction(async (publishMetadataUri, deployMetadata, signer, initializerFunction, paramValues, options) => {
   ...
   * @internal
   */
  deployViaCustomFactory = buildDeployTransactionFunction(async (constructorParamValues, deployMetadata, signer, chainId) => {
  ...
  async getRegistry() {
    ...
    return this._registry = this.getProvider().getNetwork().then(async (_ref2) => {
      ...
      const TWRegistryABI = (await import("./TWRegistry-W4UZRMNQ.js")).default;
   ...
   * @param options - the deploy options
   */
  deployContractFromUri = buildDeployTransactionFunction(async (publishMetadataUri, constructorParamValues, options) => {
    const signer = this.getSigner();
...
${bytecode}`);
   ...
   * @param constructorParams - the constructor params to pass to the contract
   */
  deployContractWithAbi = buildDeployTransactionFunction(async (abi, bytecode, constructorParams) => {
    const signer = this.getSigner();
    const provider = this.getProvider();
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/getStatus-7ee3964f.browser.esm.js
init_lib();
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/utils/hashing/sha256.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/utils/client-id.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/client/client.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/transaction/prepare-transaction.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/transaction/prepare-contract-call.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/base-sepolia.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/base.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/optimism-sepolia.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/optimism.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/zora-sepolia.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/chain-definitions/zora.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/chains/constants.js
var opChains = [
  base.id,
  baseSepolia.id,
  optimism.id,
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/utils/promise/once.js
function once(fn) {
  let result;
  return () => {
    if (!result) {
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/extensions/erc20/__generated__/IERC20/write/approve.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/extensions/erc20/write/approve.js
  ...
  return approve({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals } = await import("./decimals-67SV7YEA.js");
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/pay/utils/definitions.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getQuote.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getStatus.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getHistory.js
...
// node_modules/.pnpm/thirdweb@5.29.6_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18.3.26_buff_c058282b6cfdb3c3dc6baf54d128684f/node_modules/thirdweb/dist/esm/contract/deployment/utils/create-2-factory.js
...
var PropertiesInput = (() => external_exports.object({}).catchall(external_exports.union([BigNumberTransformSchema, external_exports.unknown()])))();
var OptionalPropertiesInput = (() => external_exports.union([external_exports.array(PropertiesInput), PropertiesInput]).optional())();
var EditionMetadataOutputSchema = (() => external_exports.object({
...
var EditionMetadataInputSchema = (() => external_exports.object({
  supply: BigNumberishSchema,
  metadata: CommonNFTInput
}))();
var EditionMetadataInputOrUriSchema = (() => external_exports.object({
  supply: BigNumberishSchema,
  metadata: NFTInputOrUriSchema
}))();
var TokenMintInputSchema = (() => external_exports.object({
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/watchTransactions-95d1cc2b.browser.esm.js
init_lib();
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./smart-contract-ac432d60.browser.esm-IUU4MMMV.js")]);
...
async function getContract2(params) {
  ...
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./contract-publisher-01e4eba8.browser.esm-ZD2HI4AW.js").then(function(n) {
    return n.c;
  })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/thirdweb-dev-sdk.browser.esm.js
init_lib();
...
*/
//# sourceMappingURL=chunk-LCZXP3DY.js.map
