...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/pack-02f90278.browser.esm.js
init_lib();
...
var PackVRF = class {
   ...
   * @twfeature PackVRF
   */
  open = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this = this;
   ...
   * @twfeature PackVRF
   */
  claimRewards = buildTransactionFunction(/* @__PURE__ */ (() => {
    var _this2 = this;
...
var Pack = class _Pack extends StandardErc1155 {
   ...
   * ```
   */
  create = buildTransactionFunction(async (metadataWithRewards) => {
   ...
   * ```
   */
  addPackContents = buildTransactionFunction(async (packId, packContents) => {
   ...
   * ```
   */
  createTo = buildTransactionFunction(async (to, metadataWithRewards) => {
...
//# sourceMappingURL=pack-02f90278.browser.esm-VYRAUZGX.js.map
