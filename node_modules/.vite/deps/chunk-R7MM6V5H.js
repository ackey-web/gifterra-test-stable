...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/contract-publisher-01e4eba8.browser.esm.js
init_lib();
...
var ContractPublisher = class extends RPCConnectionHandler {
   ...
   */
  updatePublisherProfile = buildTransactionFunction(async (profileMetadata) => {
  ...
  publish = buildTransactionFunction(async (predeployUri, extraMetadata) => {
  ...
  unpublish = buildTransactionFunction(async (publisher, contractId) => {
...
//# sourceMappingURL=chunk-R7MM6V5H.js.map
