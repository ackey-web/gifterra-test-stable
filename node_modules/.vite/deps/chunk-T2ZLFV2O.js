...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/QueryParams-32a56510.browser.esm.js
init_lib();
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-MONVI52P.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-BMU45K7P.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-JPF6IVFH.js")).default;
...
//# sourceMappingURL=chunk-T2ZLFV2O.js.map
