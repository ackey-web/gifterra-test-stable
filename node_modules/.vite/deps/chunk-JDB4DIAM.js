...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/erc-721-27306550.browser.esm.js
init_lib();
var Erc721Burnable = class {
   ...
   * ```
   */
  token = buildTransactionFunction(async (tokenId) => {
...
var Erc721ClaimableWithConditions = class {
   ...
   */
  to = buildTransactionFunction(async (destinationAddress, quantity, options) => {
...
var Erc721LoyaltyCard = class {
   ...
   * ```
   */
  cancel = buildTransactionFunction(async (tokenId) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "cancel",
      args: [tokenId]
   ...
   * ```
   */
  revoke = buildTransactionFunction(async (tokenId) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "revoke",
      args: [tokenId]
...
var Erc721UpdatableMetadata = class {
   ...
   * ```
   */
  update = buildTransactionFunction(async (tokenId, metadata) => {
...
var Erc721BatchMintable = class {
   ...
   * ```
   */
  to = buildTransactionFunction(async (to, metadatas) => {
...
var Erc721Mintable = class {
   ...
   * ```
   */
  to = buildTransactionFunction(async (to, metadata) => {
...
var Erc721SharedMetadata = class {
   ...
   * @returns  Receipt for the transaction
   */
  set = buildTransactionFunction(async (metadata) => {
...
var TieredDropPayloadSchema = (() => BaseSignaturePayloadInput.extend({
  tierPriority: external_exports.array(external_exports.string()),
...
var Erc721TieredDrop = class {
  ...
  createBatchWithTier = buildTransactionFunction(async (metadatas, tier, options) => {
    const startFileNumber = await this.erc721.nextTokenIdToMint();
    const batch = await uploadOrExtractURIs(metadatas, this.storage, startFileNumber.toNumber(), options);
    const baseUri = getBaseUriFromBatch(batch);
    return Transaction.fromContractWrapper({
  ...
  createDelayedRevealBatchWithTier = buildTransactionFunction(async (placeholder, metadatas, password, tier, options) => {
    if (!password) {
  ...
  reveal = buildTransactionFunction(async (batchId, password) => {
    if (!password) {
      throw new Error("Password is required");
    }
    const chainId = await this.contractWrapper.getChainID();
...
var Erc721 = class {
   ...
   * @twfeature ERC721
   */
  transfer = buildTransactionFunction(async (to, tokenId) => {
   ...
   * @twfeature ERC721
   */
  transferFrom = buildTransactionFunction(async (from, to, tokenId) => {
   ...
   * @internal
   */
  setApprovalForToken = buildTransactionFunction(async (operator, tokenId) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "approve",
   ...
   * @twfeature ERC721Mintable
   */
  mintTo = buildTransactionFunction(async (receiver, metadata) => {
   ...
   */
  mintBatch = buildTransactionFunction(async (metadatas) => {
   ...
   * @twfeature ERC721BatchMintable
   */
  mintBatchTo = buildTransactionFunction(async (receiver, metadatas) => {
   ...
   */
  burn = buildTransactionFunction(async (tokenId) => {
   ...
   */
  claim = buildTransactionFunction(async (quantity, options) => {
   ...
   * @twfeature ERC721ClaimCustom | ERC721ClaimPhasesV2 | ERC721ClaimPhasesV1 | ERC721ClaimConditionsV2 | ERC721ClaimConditionsV1 | ERC721ClaimZora
   */
  claimTo = buildTransactionFunction(async (destinationAddress, quantity, options) => {
...
//# sourceMappingURL=chunk-JDB4DIAM.js.map
