...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/erc-20-9a18a51c.browser.esm.js
init_lib();
...
var Erc20Burnable = class {
   ...
   * ```
   */
  tokens = buildTransactionFunction(async (amount) => {
   ...
   * ```
   */
  from = buildTransactionFunction(async (holder, amount) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "burnFrom",
...
var Erc20ClaimableWithConditions = class {
   ...
   */
  to = buildTransactionFunction(async (destinationAddress, amount, options) => {
...
var Erc20BatchMintable = class {
   ...
   * ```
   */
  to = buildTransactionFunction(async (args) => {
...
var Erc20Mintable = class {
   ...
   * ```
   */
  to = buildTransactionFunction(async (to, amount) => {
...
var Erc20 = class {
   ...
   * @twfeature ERC20
   */
  transfer = buildTransactionFunction(async (to, amount) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "transfer",
   ...
   * @twfeature ERC20
   */
  transferFrom = buildTransactionFunction(async (from, to, amount) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "transferFrom",
   ...
   * @twfeature ERC20
   */
  setAllowance = buildTransactionFunction(async (spender, amount) => {
    return Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "approve",
   ...
   * ```
   */
  transferBatch = buildTransactionFunction(async (args) => {
    const contractEncoder = new ContractEncoder(this.contractWrapper);
   ...
   * @twfeature ERC20Mintable
   */
  mintTo = buildTransactionFunction(async (receiver, amount) => {
   ...
   */
  burn = buildTransactionFunction(async (amount) => {
   ...
   */
  claim = buildTransactionFunction(async (amount, options) => {
   ...
   * @twfeature ERC20ClaimPhasesV2 | ERC20ClaimPhasesV1 | ERC20ClaimConditionsV2 | ERC20ClaimConditionsV1
   */
  claimTo = buildTransactionFunction(async (destinationAddress, amount, options) => {
...
//# sourceMappingURL=chunk-I4HYQSP4.js.map
