...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/contract-owner-49e75547.browser.esm.js
init_lib();
var ContractRoyalty = class {
   ...
   * @twfeature Royalty
   */
  setDefaultRoyaltyInfo = buildTransactionFunction(async (royaltyData) => {
   ...
   * @twfeature Royalty
   */
  setTokenRoyaltyInfo = buildTransactionFunction(async (tokenId, royaltyData) => {
...
var DelayedReveal = class {
   ...
   */
  createDelayedRevealBatch = buildTransactionFunction(async (placeholder, metadatas, password, options) => {
    if (!password) {
  ...
  async getLegacyEncryptedData(index) {
    const DeprecatedAbi = (await import("./IDelayedRevealDeprecated-D32QYUL4.js")).default;
...
var ContractOwner = class {
   ...
   * @twfeature Ownable
   */
  set = buildTransactionFunction(async (address) => {
...
//# sourceMappingURL=chunk-LIV54TUW.js.map
