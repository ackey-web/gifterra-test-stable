...
// node_modules/.pnpm/@thirdweb-dev+sdk@4.0.99_@types+react-dom@18.3.7_@types+react@18.3.26__@types+react@18._4ecbbc39539d7059b1b8ad321c3f738a/node_modules/@thirdweb-dev/sdk/dist/contract-roles-71988d2e.browser.esm.js
var ContractRoles = class {
   ...
   *
   * */
  setAll = buildTransactionFunction(async (rolesWithAddresses, actingAddress) => {
   ...
   * @twfeature Permissions
   */
  grant = buildTransactionFunction(async (role, address) => {
    invariant(this.roles.includes(role), `this contract does not support the "${role}" role`);
   ...
   * @twfeature Permissions
   */
  revoke = buildTransactionFunction(async (role, address) => {
    invariant(this.roles.includes(role), `this contract does not support the "${role}" role`);
    const resolvedAddress = await resolveAddress(address);
...
//# sourceMappingURL=chunk-UJRE2TVX.js.map
